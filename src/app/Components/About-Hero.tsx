...
export default function AboutHero() {
  return (
    <div className="w-full flex items-center justify-center flex-col">
      <div className="relative w-[96%] md:mt-[1rem] rounded-2xl isolate overflow-hidden bg-blue-200 py-24 sm:py-32">
        <img
          alt=""
        ...
        >
          <div
            ...
            className="aspect-[1097/845] w-[68.5625rem] bg-gradient-to-tr from-[#eab308] to-[#1a98ffb4] opacity-20"
          />
        </div>
        <div
          aria-hidden="true"
            ...
            <dl className="mt-16 grid grid-cols-1 gap-8 sm:mt-20 sm:grid-cols-2 lg:grid-cols-4">
              {stats.map((stat) => (
                <div key={stat.name} className="flex flex-col-reverse">
                  <dt className="text-base leading-7 text-blue-500">
                    {stat.name}
                  </dt>
                  <dd className="text-2xl font-bold leading-9 tracking-tight text-blue-800">
                    {stat.value}
                  </dd>
                </div>
              ))}
